...
An end-to-end unsupervised learning project using the UCI Seeds dataset. This implementation features:

1. DBSCAN with automated k-distance parameter tuning
2. Bisecting K-means implemented from scratch
